...
#define _DESCRIPTORS_H_
	...
	/* Includes: */
		...
		#define VENDOR_OUT_EPSIZE 8

		/* Macros: */
		/** Endpoint address : On utilise l'endpoint 1 pour IN, et 2 pour OUT */
	...
	/* Type Defines: */
		...
		*/
		enum InterfaceDescriptors_t
		{
			INTERFACE_ID_Vendor = 0, /**< Interface Vendor-specific */
		};
